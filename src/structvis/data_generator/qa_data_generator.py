...
from src.prompt_templates.templates_enrichment import PROMPT_LLM_QA, SYSTEM_LLM_QA
...
def main():
    ...
    generator = QaDataGenerator(
        ...
        input_path="/data/data/structvis/datasets_v10/dataset_assembled/dataset_llm_qa_gen.jsonl",  # dataset_association_caption
